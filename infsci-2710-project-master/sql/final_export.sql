...
--
-- Host: localhost
-- Generation Time: Apr 16, 2019 at 03:40 AM
...
(27, 'Keanu', 'Brown', '7238 Saxon Road ', 19188, '542-393-0099', 12, 52),
(28, 'Ebrahim', 'Morton', '622 South Hartford Court', 78550, '200-155-4523', 13, 9),
(29, 'Riaan', 'Guilano', '9 Meadow Drive ', 56233, '980-123-3541', 14, 51),
(30, 'Collette', 'Lowery', '8970 Court Street ', 78451, '788-200-1456', 15, 46),
(31, 'Emil', 'Terrel', '8393 Shirley Street', 45002, '102-445-7788', NULL, 51),
(32, 'Ami', 'Shanan', '622 South Hartford Court ', 31162, '311-855-4522', 16, 6),
(33, 'Elani', 'Guthrie', '19 Harrison Street', 85222, '656-322-1455', 17, 25),
(34, 'Aman', 'Alexander', '83 W. Courtland Lane', 85522, '244-789-9455', 18, 42),
(35, 'Dustin', 'Lu', '9434 Ridgeview Street ', 84450, '544-741-1225', 19, 4),
(36, 'Adnan', 'Gupta', '64 High Noon Street', 60004, '900-166-3255', 20, 39),
(37, 'Ameera', 'Moretti', '1 Saxton Ave', 62210, '744-555-4122', 21, 52),
(38, 'Farah', 'Narin', '9640 Tarkiln Hill St', 52145, '633-455-5110', 22, 43),
(39, 'Manuel', 'Bains', '7541 Broad Street', 85522, '451-777-8500', 23, 18),
(40, 'Pia', 'Corrigan', '64 1st Drive', 54888, '744-555-8966', NULL, 16),
(41, 'Yousif', 'Fara', '172 East Court', 78444, '313-555-7444', NULL, 28),
(42, 'Bilaal', 'Mavan', '8053 Mayfair St', 85544, '300-985-2014', NULL, 30),
(43, 'Kiri', 'Owens', '7789 Overlook St', 85411, '455-788-9652', NULL, 29),
(44, 'Manuel', 'Banes', '430 4th Avenue', 74451, '102-444-8955', NULL, 49),
(45, 'Cherry', 'Hayden', '48 Saxton Street', 50011, '655-444-7822', NULL, 39),
(46, 'Mylie', 'Coles', '9103 John Circle ', 24557, '785-888-5200', NULL, 40),
(47, 'Chance', 'Benson', '706 Center Street ', 50244, '744-559-6522', NULL, 38),
(48, 'Elisa', 'Rees', '823 Studebaker Ave', 30047, '988-554-7444', NULL, 8),
(49, 'Arianna', 'Graves', '115 Newcastle Rd', 85541, '300-740-1054', NULL, 51),
(50, 'Zavier', 'Campbell', '173 Park St', 57884, '202-699-9855', NULL, 51),
(51, 'Serenity', 'Walsh', '149 Tarkiln Hill Street ', 80021, '454-700-1200', NULL, 27),
(52, 'Tia', 'Arrelano', '173 Park St', 75520, '333-200-1450', NULL, 26),
(53, 'Braylon', 'Shields', '906 Holly Ave', 50014, '879-355-4700', NULL, 1),
(54, 'Laci', 'Howell', '233 High Lane ', 98555, '655-874-8963', NULL, 40),
(55, 'Keegan', 'Garison', '7348 Riverside Lane', 15440, '554-677-8504', NULL, 4);
...
--
ALTER TABLE `Business`
  MODIFY `business_id` int(20) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=24;
--
...
--
ALTER TABLE `Customer`
  MODIFY `customer_id` int(20) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=56;
--
